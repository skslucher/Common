...
public class CharacterController2D : MonoBehaviour
{
	...
	public void recalculateDistanceBetweenRays()
	{
		...
		// horizontal
		var colliderUseableHeight = boxCollider.size.y * Mathf.Abs( transform.lossyScale.y ) - ( 2f * _skinWidth );
		_verticalDistanceBetweenRays = colliderUseableHeight / ( totalHorizontalRays - 1 );

		// vertical
		var colliderUseableWidth = boxCollider.size.x * Mathf.Abs( transform.lossyScale.x ) - ( 2f * _skinWidth );
